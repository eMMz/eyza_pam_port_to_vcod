...
//	 	maps\mp\_utility::error("no defined weapon for the spawning player");
	...
	if(isDefined(self.pers["weapon1"]) && isDefined(self.pers["weapon2"]))
	{
		...
		ammount = maps\mp\gametypes\_pam_loadout_gmi::GetGunAmmo(self.pers["weapon1"]);
		...
		ammount = maps\mp\gametypes\_pam_loadout_gmi::GetGunAmmo(self.pers["weapon2"]);
	...
	else
	{
		...
		ammount = maps\mp\gametypes\_pam_loadout_gmi::GetGunAmmo(self.pers["weapon"]);
	...
	self maps\mp\gametypes\_weapons::giveGrenadesFor(self.pers["weapon"]);
	self maps\mp\gametypes\_weapons::giveBinoculars(self.pers["weapon"]);
