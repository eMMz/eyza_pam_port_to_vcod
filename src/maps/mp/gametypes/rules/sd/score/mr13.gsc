...
GetCvars(arr)
{
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sd_half_round", 13);	// Number of rounds when half-time starts. 0=ignored
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sd_end_round", 26);	// Number of rounds when map ends. 0=ignored
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sd_end_score", 14);	// Number of score when map ends. 0=ignored
