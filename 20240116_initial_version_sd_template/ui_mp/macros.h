...
\
	...
	MATCHINFO_ICON(-128 1, "gfx/icons/hud@us_grenade.tga", cvar_team1_team, showcvar { "american" } ) \
	MATCHINFO_ICON(-128 1, "gfx/icons/hud@us_grenade.tga", cvar_team1_team, showcvar { "british" } ) \
	MATCHINFO_ICON(-128 1, "gfx/icons/hud@us_grenade.tga", cvar_team1_team, showcvar { "russian" } ) \
	MATCHINFO_ICON(-128 1, "gfx/icons/hud@us_grenade.tga", cvar_team1_team, showcvar { "german" } ) \
\
\
...
\
	ITEM_SCOREBOARD_HEADING(x, y, "Kills",    SCOREBOARD_KILLS_TEXT_X,   	23, .1575 /* .21 orig */, ITEM_ALIGN_CENTER, 	SCOREBOARD_KILLS_TEXT_X, 	25, 	30) \
	ITEM_SCOREBOARD_HEADING(x, y, "Deaths",   SCOREBOARD_DEATHS_TEXT_X,  	33, .1575, ITEM_ALIGN_CENTER, 	SCOREBOARD_DEATHS_TEXT_X, 	35, 	20) \
	ITEM_SCOREBOARD_HEADING(x, y, "Assists",  SCOREBOARD_ASSISTS_TEXT_X, 	23, .1575, ITEM_ALIGN_CENTER, 	SCOREBOARD_ASSISTS_TEXT_X, 	25, 	30) \
\
...
\
	ITEM_SCOREBOARD_COLUMN(x, y, "ui_scoreboard_names",    SCOREBOARD_NAME_X,     40, .135 /* .18 */, ITEM_ALIGN_LEFT) \
	ITEM_SCOREBOARD_COLUMN(x, y, "ui_scoreboard_kills",    SCOREBOARD_KILLS_X,    40, .135, ITEM_ALIGN_LEFT) \
	ITEM_SCOREBOARD_COLUMN(x, y, "ui_scoreboard_deaths",   SCOREBOARD_DEATHS_X,   40, .135, ITEM_ALIGN_LEFT) \
	ITEM_SCOREBOARD_COLUMN(x, y, "ui_scoreboard_assists",  SCOREBOARD_ASSISTS_X,  40, .135, ITEM_ALIGN_LEFT) \
	ITEM_SCOREBOARD_COLUMN(x, y, "ui_scoreboard_ping",     SCOREBOARD_PING_X,     40, .135, ITEM_ALIGN_LEFT)
