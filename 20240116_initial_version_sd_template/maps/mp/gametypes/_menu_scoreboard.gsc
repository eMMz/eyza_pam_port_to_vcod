...
addLine(stats, name, score, kills, deaths, assists, damages, grenades, plants, defuses)
{
	...
	if (!isDefined(stats))
	{
		...
		/*
		self.scoreboard.names +=	"emptyNames" + self.scoreboard.i;
		self.scoreboard.scores +=	"emptyScores" + self.scoreboard.i;
		self.scoreboard.kills +=	"emptyKills" + self.scoreboard.i;
		self.scoreboard.deaths +=	"emptyDeath" + self.scoreboard.i;
		self.scoreboard.assists +=	"emptyAssists" + self.scoreboard.i;
		self.scoreboard.damages +=	"emptyDamages" + self.scoreboard.i;
		self.scoreboard.grenades +=	"emptyGrenades" + self.scoreboard.i;
		self.scoreboard.plants +=	"emptyPlants" + self.scoreboard.i;
		self.scoreboard.defuses +=	"emptyDefuses" + self.scoreboard.i;
		*/
